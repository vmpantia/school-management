namespace SM.Api.Commons
{
    public class Constants
    {
        ...
        public const string ERROR_FUNCTION_ID_NOT_FOUND = "Function ID [{0}] doesn't exist in the System.";
        ...
        public const string MODEL_STUDENT_TRN = "Student Transaction";
        public const string MODEL_CONTACTS = "Contacts";
        public const string MODEL_CONTACTS_TRN = "Contacts Transaction";
        public const string MODEL_ADDRESSES = "Addresses";
        public const string MODEL_ADDRESSES_TRN = "Addresses Transaction";
        #endregion
    }
}
